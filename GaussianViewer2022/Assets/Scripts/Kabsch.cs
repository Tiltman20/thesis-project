// developed by Jonathon Selstad @ https://github.com/zalo/MathUtilities/
using UnityEngine;
...
public class Kabsch : MonoBehaviour {
  ...
  public Matrix4x4 kabschTransform;
  public Vector3[] points; Vector4[] refPoints;
  ...
  public Matrix4x4 Init()
    {
        ...
        kabschTransform = solver.SolveKabsch(points, refPoints);

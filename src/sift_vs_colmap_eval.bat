...
C:\Users\tilma\Documents\GitHub\bachelor-thesis\thesis-project-1\.venv\Scripts\python.exe .\src\execute_pipeline.py --noimport --noscale -s res\evaluation-research\test9\xfeat --top_k 4096
